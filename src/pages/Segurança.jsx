...
function Seguranca() {
  return (
    <div style={{ backgroundImage: "url('/servitech/images/familia-feliz.jpg')", backgroundRepeat: "no-repeat", 
      backgroundSize: "cover", backgroundAttachment: "fixed", width: "100%", minHeight: "100vh", padding: "1rem" }}>
